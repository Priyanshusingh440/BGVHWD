    ...
    <div class="container-fluid">
      ...
      <div class="content">
          ...
          <p style="margin-top: 3%;"> I confirm that all the 
            information I have provided to (“The Employer”) at any stage of the job application 
            process, whether it is information provided in the form of documentation or verbally,
            is true and complete to the best of my knowledge and belief. I also confirm that I 
            have answered all questions put to me by or on behalf of The Employer fully and 
            accurately.
          <p  style="margin-top: 2%;">I understand that any offer of employment is conditional upon 
                satisfactory references and the background verification of all information I have 
                provided, in accordance with the relevant laws and regulations.
            </p>
            ...
            <p>I acknowledge and consent to a criminal background check in countries 
            ...
            <h6 style="margin-top: 5%; font-size: 20px;">Name : Jhony Watson</h6>
      ...
      <div class="row justify-content-center" style="margin-bottom: 2%; margin-top: 2%;">
        <button id="btn1" style="margin-right: 5%;" class="btn btn-primary">I ACCEPT</button>
        <button id="btn2" class="btn btn-primary">I DO NOT ACCEPT</button>
      </div>
